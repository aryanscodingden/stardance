class Admin::Certificates::ApprovalsController < Admin::ApplicationController
  def create
    ...
    if certificate.nil?
      ...
      redirect_to admin_certificates_path, notice: "Certificate for “#{certificate.name}” approved."
    end
  end
end
